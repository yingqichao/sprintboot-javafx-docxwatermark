...
public final class QRCode {
  ...
  private int matrixWidth;//矩阵宽度
  private int maskPattern;//掩码图案
  private int numTotalBytes;//总比特
  private int numDataBytes;//总数据比特(除去纠错比特)
  private int numECBytes;//纠错比特
  private int numRSBlocks;//RS码块数
  private ByteMatrix matrix;
  private BufferedImage matrix2;
  private  int validDataBytes;//有效比特数(除去填充比特)
  private HashSet<XyDir> xyData;
  private File graphUri;
  private File outPutFile;
  private int[][] rsGraph;//41基础图
  private int[][] hdGraph;//基准图
  private int[][] GrayGraph;
  private BufferedImage Graph;
  private BitArray rsCode;//嵌入的rs编码
  private HashSet<XyDir> xyPadding;
  private String ex;
  ...
  public BufferedImage getMatrix2() {
	    return matrix2;
}
  ...
  public int getValidDataBytes() {
    return validDataBytes;
  }

  public File getGraphUri() {return graphUri;}

  public void setGraphUri(File graphUri) {this.graphUri = graphUri;}

  public HashSet<XyDir> getXyData() {
    return xyData;
  }

  public void setXyData(HashSet xyData) {
    this.xyData = xyData;
  }
  ...
  public void setRsGraph(int[][] rsGraph) {
    this.rsGraph = rsGraph;
  }

  public int[][] getHdGraph() {
    return hdGraph;
  }
  public int[][] getGrayGraph() {
	    return GrayGraph;
}
  
  public void setGrayGraph(int[][] GrayGraph) {
	  this.GrayGraph=GrayGraph;
}
  
  public void setHdGraph(int[][] hdGraph) {
    this.hdGraph = hdGraph;
  }
  
  
  public BitArray getRsCode() {
    return rsCode;
  }

  public void setRsCode(BitArray rsCode) {
    this.rsCode = rsCode;
  }


  public HashSet<XyDir> getXyPadding() {
    return xyPadding;
  }

  public void setXyPadding(HashSet<XyDir> xyPadding) {
  ...
  public void setValidDataBytes(int value) {
    validDataBytes = value;
  }
  // This takes ownership of the 2D array.
  public void setMatrix(ByteMatrix value) {
    matrix = value;
  }
  public void setMatrix2(BufferedImage value) {
	    matrix2 = value;
}
